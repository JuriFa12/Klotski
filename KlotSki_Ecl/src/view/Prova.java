	...
	public void start (Stage stage) throws Exception
	{
	    ...
	    config1.setOnAction(new EventHandler<ActionEvent>() {
	         ...
	         public void handle(ActionEvent event)
	         {
	        	 ...
	        	 c.setConfiguration(game,a,root,1,t);
	    ...
	    config2.setOnAction(new EventHandler<ActionEvent>() {
	         ...
	         {
	        	 SetConfigurationController c = new SetConfigurationController();
	        	 c.setConfiguration(game,a,root,2,t);
	    ...
	    config3.setOnAction(new EventHandler<ActionEvent>() {
	         ...
	         {
	        	 SetConfigurationController c = new SetConfigurationController();
	        	 c.setConfiguration(game,a,root,3,t);
	    ...
	    left.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         public void handle(ActionEvent event)
	         {
	        	 ...
	        	 c.move(a, game, root,2,t); //2 numero per sinistra
	    ...
	    right.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         {
	        	 MovePieceController c = new MovePieceController();
	        	 c.move(a, game, root,3,t); //3 numero per destra
	         }
	    ...
	    up.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         {
	        	 MovePieceController c = new MovePieceController();
	        	 c.move(a, game, root,0,t); //0 numero per sopra
	         }
	    ...
	    down.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         {
	        	 MovePieceController c = new MovePieceController();
	        	 c.move(a, game, root,1,t); //1 numero per sotto
	         }
