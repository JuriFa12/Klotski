...
public class Board 
{
    ...
    public void setPieces()
    {
        if (configuration == 2)
        {
            pieces[0] = new Piece(1,1,2,1);//0
            pieces[1] = new Piece(1,2,2,2);//1
            pieces[4] = new Piece(1,4,2,1);//4
            pieces[6] = new Piece(3,1,2,1);//6
            pieces[5] = new Piece(3,2,1,2);//5
            pieces[2] = new Piece(4,2,1,1);//2
            pieces[3] = new Piece(4,3,1,1);//3
            pieces[8] = new Piece(3,4,2,1);//8
            pieces[7] = new Piece(5,1,1,1);//7
            pieces[9] = new Piece(5,4,1,1);//9
        ...
        else 
        {
            if (configuration == 1)
            {
                pieces[0] = new Piece(1,1,2,1);//0
                pieces[1] = new Piece(1,2,2,2);//1
                pieces[2] = new Piece(1,4,1,1);//2
                pieces[3] = new Piece(2,4,1,1);//3
                pieces[4] = new Piece(3,1,2,1);//4
                pieces[5] = new Piece(3,2,1,2);//5
                pieces[6] = new Piece(3,4,2,1);//6
                pieces[7] = new Piece(4,2,1,1);//7
                pieces[8] = new Piece(4,3,2,1);//8
                pieces[9] = new Piece(5,2,1,1);//9
            ...
            else
            {
                if (configuration == 3)
                {
                    pieces[0] = new Piece(1,1,1,1);//2
                    pieces[1] = new Piece(1,2,2,2);//1
                    pieces[2] = new Piece(1,4,1,1);//3
                    pieces[3] = new Piece(2,1,2,1);//0
                    pieces[4] = new Piece(2,4,2,1);//4
                    pieces[5] = new Piece(3,2,2,1);//6
                    pieces[6] = new Piece(4,1,1,1);//7
                    pieces[7] = new Piece(4,4,1,1);//
                    pieces[8] = new Piece(5,1,1,2);//
                    pieces[9] = new Piece(5,3,1,2);//5
