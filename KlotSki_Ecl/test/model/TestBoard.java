...
class TestBoard {
    ...
    void testBoard() {
        ...
        // Verifica le condizioni iniziali della board
    ...
    void testSetPiecesAndGetData() {
        ...
        // Verifica che gli array di piece e data siano corretti
    ...
    void testSetAndGetConfiguration() {
        ...
        // Imposta una nuova configurazione e verifica se è stata impostata correttamente
    ...
    void testSetConfigurationException() {
        ...
        // Verifica che l'impostazione di una configurazione non valida sollevi un'eccezione
    ...
    void testFindPieceIndex() {
        ...
        // Verifica l'indice di una piece presente sulla board
        assertEquals(testBoard.findPieceIndex(3, 2), 5);
        
        // Verifica l'indice di una piece non presente sulla board
    ...
    void testCheckWin() {
        ...
        // Verifica se il metodo checkWin restituisce false sulla board di default
    ...
    void testGetPieces() {
        ...
        // Verifica che la lunghezza dell'array pieces sia corretta
        assertEquals(10, testBoard.getPieces().length);
    }
    ...
    void testSetAndGetSelected() {
        ...
        // Verifica che la piece selezionata inizialmente sia nulla
        assertNull(testSelected);

        // Imposta una nuova piece selezionata e verifica che le dimensioni siano corrette
    ...
    void testReset() {
        ...
        // Seleziona una piece e muovila
        testBoard.selectPiece(5, 2);
        testBoard.movePiece(2);
        assertEquals(1, testBoard.getMoves());

        // Resettare la board e verifica che le condizioni iniziali siano ripristinate
        testBoard.reset();
        assertEquals(0, testBoard.getMoves());
        assertNull(testBoard.getSelected());
        assertFalse(testBoard.getWin());
        ...
        // Verifica che l'array di pieces sia ripristinato correttamente
        assertArrayEquals(testPieces, testBoard.getPieces());
    }
    ...
    void testAvailable() {
        ...
        // Verifica se una determinata posizione è disponibile sulla board di default
        assertTrue(testBoard.isAvaible(5, 1));

        // Sposta una piece e verifica che la posizione non sia più disponibile
    ...
    void testOutOfBounds() {
        ...
        // Verifica se una piece è fuori dai limiti della board di default
    ...
    void testMovePieceAndGetMoves() {
        ...
        // Verifica che una mossa non valida restituisca false
        assertFalse(testBoard.movePiece(0));

        // Seleziona una piece e spostala, verifica che le mosse e l'undoState siano corretti
        testBoard.setSelected(9);
        assertTrue(testBoard.movePiece(2));
        assertEquals(1, testBoard.getMoves());
        assertEquals(1, testBoard.getUndoState());

        // Seleziona una piece non valida e verifica che la mossa non sia valida
    ...
    void testUndo() {
        ...
        // Seleziona una piece e spostala, esegui l'undo e verifica che le pieces siano ripristinate
        testBoard.setSelected(9);
        testBoard.movePiece(2);
        testBoard.undo();
