...
public class Prova extends Application
{
	...
	public void start (Stage stage) throws Exception
	{
		...
		up.setTranslateY(650);
		
		down.setText("Down");
		down.setTranslateX(700);
		...
		*/
	    ...
	    left.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         public void handle(ActionEvent event)
	         {
	        	 ...
	        	 c.move(a, game, root,2); //2 numero per sinistra
	         }
	    ...
	    right.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         {
	        	 MovePieceController c = new MovePieceController();
	        	 c.move(a, game, root,3); //3 numero per destra
	         }
	    ...
	    up.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         {
	        	 MovePieceController c = new MovePieceController();
	        	 c.move(a, game, root,0); //0 numero per sopra
	         }
	    ...
	    down.setOnAction(new EventHandler<ActionEvent>() 
	    {
	         ...
	         {
	        	 MovePieceController c = new MovePieceController();
	        	 c.move(a, game, root,1); //1 numero per sotto
	         }
